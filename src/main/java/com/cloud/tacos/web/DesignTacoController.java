package com.cloud.tacos.web;

import com.cloud.tacos.Ingredient;
import com.cloud.tacos.Ingredient.Type;
import com.cloud.tacos.Order;
import com.cloud.tacos.Taco;
import com.cloud.tacos.data.IngredientRepository;
    ...
    public String showDesignForm(Model model) {
        ...
        for (Type type : types) {
            model.addAttribute(type.toString().toLowerCase(),
                    filterByType(ingredients, type.toString()));
        }
